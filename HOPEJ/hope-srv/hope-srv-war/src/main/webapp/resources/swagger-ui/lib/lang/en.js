...
var d = {
    "apiVersion": "1.0.0",
    "swaggerVersion": "1.2",
    "basePath": "http://localhost:8080/eRoom",
    "resourcePath": "/api",
    "produces": [],
    "consumes": [],
    "protocols": [],
    ...
    "apis": [{
        ...
        "operations": [{
            ...
            "notes": "Check authentication",
            "responseClass": "Single[string]",
            ...
            "authorizations": [{
                "type": "oauth2",
                "scopes": [{"scope": "read", "description": "says id authenticated"}]
            }],
            "parameters": [],
            "responseMessages": [],
            "deprecated": null
        ...
        "operations": [{
            ...
            "responseClass": "Single[SystemInfo]",
            "nickname": "getSystemInfo",
            "position": 0,
            "produces": ["application/json"],
            "consumes": [],
            "protocols": [],
            "authorizations": [{"type": "", "scopes": [{"scope": "", "description": ""}]}],
            "parameters": [],
            "responseMessages": [{"code": 200, "message": "OK", "responseModel": "SystemInfo"}],
            "deprecated": null
        }]
    }],
    "models": {
        "SystemInfo": {
            "id": "SystemInfo",
            "name": "SystemInfo",
            "qualifiedType": "ua.com.csltd.eroom.api.model.SystemInfo",
            "properties": {
                "name": {
                    "type": "string",
            ...
            "description": "Этот бин содержит в себе очень важную информацию о системе",
